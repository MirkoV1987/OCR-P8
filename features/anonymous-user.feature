Feature:
  ...
  Scenario: A anonymous user register to the website
    ...
    Then I enter "Mon mot de passe" in the "Tapez le mot de passe à nouveau" field
    Then I enter "mirko@mysite.com" in the "Adresse email" field
  ...
  Scenario: A anonymous user tries to register to the website and miss confirmation password
    ...
    Then I enter "Mirko" in the "Nom d'utilisateur" field
    Then I enter "Mon mot de passe" in the "Mot de passe" field
    Then I enter "Mon mot de passeXXX" in the "Tapez le mot de passe à nouveau" field
    Then I enter "mirko@mysite.com" in the "Adresse email" field
    When I click on button "Ajouter"
